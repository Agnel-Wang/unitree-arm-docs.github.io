...
机械臂零位姿态如下图，J1、J5、J6关节缝隙两侧的线完全对应，其他关节摆放到位即可。想要任意位置上电运行，运行z1_ctrl控制器，按下 **~**键待机械臂停止后按下**Tab**键，此后可对机械臂进行操作。如果每次机械臂开机都在**零位**，可在`include/config/config.xml`中可以关闭此功能。
